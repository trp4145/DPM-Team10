...
public class Odometer extends Thread
{
	...
	/**
	 * Main loop run periodically to update the assumed robot transform using the motor tachometers.
	 */
	public void run()
	{
		long updateStart;
    ...
    /**
     * @return the robot's position in cm.
     */
